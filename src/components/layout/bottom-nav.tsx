...
export function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-30 border-t border-surface-700 bg-surface-900/95 backdrop-blur-lg safe-area-bottom">
                ...
                {navItems.map((item) => {
                    ...
                    if (item.isAction) {
                        return (
                            ...
                            >
                                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-600 text-white shadow-lg shadow-brand-600/30 transition-transform active:scale-95">
                                    {item.icon}
                                </div>
